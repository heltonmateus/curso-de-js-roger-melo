...
/*
03 - Use o método adequado para adicionar os 3 seguintes itens 
ao array:
...
//reatribuicao = brazilianFoods[1] = 'Pão de Queijo'
//console.log(brazilianFoods, reatribuicao);
...
const foodsInfo = "Até aqui, brazilianFoods possui" + ' '
 + brazilianFoods.length + ' ' + "itens: " + brazilianFoods[0] + ' ' 
 + brazilianFoods[1] + ' ' + brazilianFoods[3]
...
//console.log(`${dogNames[0]}, ${dogNames[1]}, ${dogNames[2]}, ${dogNames[3]}`)
