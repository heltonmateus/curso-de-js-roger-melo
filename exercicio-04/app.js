...
const my3FavoriteTVShows = ['bichio', 'batman', 'musica']
...
const nCaracteres = 39

//console.log(`"A string que a "typeSentence" armazena tem mais de ${nCaracteres} caracteres? ${String(typeSentence.length > nCaracteres).replace('t', 'T')}."`)
