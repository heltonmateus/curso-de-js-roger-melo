...
const myFavoriteTom = tom + ' ' + firsTom + ' ' + secondTom;
...
- Ao invés de inserir manualmente a posição do último caractere, faça com que
 a obtenção da última letra funcione para qualquer palavra que a "randomWord" 
 receber;
...
- Após a const "harryPotterAuthor" (abaixo), exiba no 
console a parte "J.K." da string "harryPotterAuthor";
...
- Atribua à "realBestMovie" a mesma string da "bestMovie", mas 
substituindo o nome do filme para "Moonlight";
...
- Abaixo deste comentário, armazene o resto de 10 dividido por 3 em 
uma constante "reminder";
...
- Abaixo deste comentário, armazene a string 'O nº de episódios
 é: NUMERO_DE_EPISÓDIOS' em uma constante "allEpisodes";
...
/*
21 - Comente o console.log acima (e a const bookMessage caso não 
    tenha descoberto a resolução), e,
...
- A template string deverá resultar no mesmo valor
 que a "newName" tinha anteriormente
